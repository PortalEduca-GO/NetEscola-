...
const RAW_VIDEOS: VideoRecommendation[] = [
  ...
  {
    id: "gt9_mat_1",
    title: "Equações de 2º Grau - Aula Completa (9º ANO)",
  ...
  {
    id: "gt9_port_1",
    title: "Orações Coordenadas e Subordinadas - Revisão (9º ANO)",
    description: "Revise os tipos de orações e como identificá-las em textos.",
    thumbnailUrl: "https://i.ytimg.com/vi/p7XgXcE9kQg/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/playlist?list=PLwBABA4s6M7e-8w9xY5Z_zO9u7L4k3J7m", 
    subject: "Português",
    gradeLevel: [SchoolGrade.ANO_9_EF],
    source: 'GoiásTec',
  },
  {
    id: "gt1_fis_1",
    title: "Introdução à Cinemática - MRU e MRUV (1ª SÉRIE EM)",
  ...
  {
    id: "gt1_qui_1",
    title: "Modelos Atômicos - Dalton, Thomson, Rutherford, Bohr (1ª SÉRIE EM)",
    description: "Evolução dos modelos atômicos e suas características.",
    thumbnailUrl: "https://i.ytimg.com/vi/dZq3Q_RFSNg/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/playlist?list=PLwBABA4s6M7cK_l_m_nJ8hP_tQ_eR2Y_z",
    subject: "Química",
    gradeLevel: [SchoolGrade.SERIE_1_EM],
    source: 'GoiásTec',
  },
   {
    id: "gt2_bio_1",
    title: "Genética Mendeliana - Leis de Mendel (2ª SÉRIE EM)",
    ...
    videoUrl: "https://www.youtube.com/playlist?list=PLwBABA4s6M7fG_h_J_kL9oP_x_T_wR_yQ",
    subject: "Biologia",
   ...
   {
      id: "gt2_qui_1", 
      title: "QUÍMICA - SOLUÇÕES: CONCEITOS E CLASSIFICAÇÕES - AULA 01 (2ª Série)",
  ...
  {
      id: "gt3_hist_1", 
      title: "HISTÓRIA - A CRISE DE 1929 E SEUS REFLEXOS NO BRASIL - AULA 01 (3ª Série)",
  ...
  // --- 3ª Série EM - Química (GoiásTec) ---
  {
      ...
      title: "QUÍMICA - TERMOQUÍMICA: ENTALPIA E LEI DE HESS - AULA 01 (3ª Série)",
  ...
  },
  {
      ...
      title: "QUÍMICA - VELOCIDADE DAS REAÇÕES - AULA 02 (3ª Série)",
  ...
  },
  {
      ...
      title: "QUÍMICA - EQUILÍBRIO QUÍMICO - AULA 03 (3ª Série)",
  ...
  // --- 3ª Série EM - Biologia (GoiásTec) ---
  {
      ...
      title: "BIOLOGIA - GENÉTICA: CONCEITOS BÁSICOS - AULA 01 (3ª Série)",
  ...
  {
      id: "yt_Yln0xSwRVtQ",
      title: "Fontes de Energia (Vestibular)",
